...
export const COMMANDS: CommandDef[] = [
  ...
  { name: 'spaces board unblock', description: 'Remove the #blocked tag', safety: 'write',
    args: [{ name: 'project', required: true, description: 'Project slug' }, { name: 'card', required: true, description: '^id or unique text' }] },
  { name: 'spaces board note', description: 'Append an indented note under a card', safety: 'write',
    args: [{ name: 'project', required: true, description: 'Project slug' }, { name: 'card', required: true, description: '^id or unique text' }, { name: 'note', required: true, description: 'Note text' }] },

 ...
 *  OWN ACCOUNT (so AL replies on WhatsApp; Yousef, 2026-09-05: "I want to
 *  WhatsApp Al sometimes so he replies on there" — never reroute this to the
 *  ring fork). He has no users/*.md (that list is AL's OWN contacts), so the
 *  hub resolves this name to his own identifiers (`alWa.ownIdentifiers()`,
 *  phone + lid) instead. */

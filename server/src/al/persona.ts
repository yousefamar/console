...
export async function buildAlSystemPrompt(): Promise<string> {
  ...
  parts.push(
    [
      ...
      '  as needed. Voice notes (the sender used the mic button, not a shared audio file) carry',
      '  an extra "Voice note transcript: \\"...\\"" line auto-transcribed by the hub — treat that',
      '  transcript as the message text.',
      '',

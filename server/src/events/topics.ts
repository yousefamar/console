...
export const BUILTIN_TOPICS: TopicDoc[] = [
  ...
  { topic: 'mail.received', description: 'A new message landed in a mailbox the hub syncs (Gmail accounts now; IMAP accounts once card F ships).',
    fields: { account: 'mailbox address', id: 'message id', threadId: 'thread id', from: 'From header', fromEmail: 'address only', subject: 'Subject', snippet: 'Gmail snippet', labels: 'label ids' } },

...
- The APK loads `https://amarhp-lin.rya-yo.ts.net:8443/` (Funnel-served, public) since v18 — works off-tailnet for the shell; hub calls on `:9877` still require Tailscale. Pre-v18 loaded `:5173` directly which was tailnet-only. HMR still works through Caddy's reverse_proxy to Vite.
